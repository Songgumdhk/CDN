var NepaliFunctions = (function () {
    ...
    function r() {
        ...
        (e[1970] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30]),
            ...
            (e[2081] = [31, 31, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30]),
    ...
    return {
                        ...
                        ? ((t.month = o[0].value),
                            ...
                            1 == i.length
                                ...
                                : ((i = i.find(function (e) {
                                    ...
                                    (t.day = i.value),
                                    (n[i.index] = "DD")))
                        : 2 == o.length && ((t.day = o[0 == a.index ? 1 : 0].value), (t.month = o[0 == a.index ? 0 : 1].value), (n[o[0].index] = 0 == a.index ? "MM" : "DD"), (n[o[1].index] = 0 == a.index ? "DD" : "MM"));
                }
        ...
        BsAddDays: function (e, t, n) {
            ...
            return (
                (r = new Date(r.year, r.month - 1, r.day)).setDate(r.getDate() + t), (r = { year: r.getFullYear(), month: r.getMonth() + 1, day: r.getDate() }), (e = NepaliFunctions.AD2BS(r)), n ? NepaliFunctions.ConvertDateFormat(e, n) : e
            );
        },
        GetBsFullDate: function (e, t, n) {
            ...
            return (
                t
                    ? ((r = ["बैशाख", "जेठ", "अषाढ", "श्रावण", "भाद्र", "आश्विन", "कार्तिक", "मङ्सिर", "पौष", "माघ", "फाल्गुन", "चैत्र"]), (a = `${B(e.day)} ${r[e.month - 1]} ${B(e.year)}`))
                    : ((r = ["Baisakh", "Jestha", "Ashar", "Shrawan", "Bhadra", "Ashoj", "Kartik", "Mangsir", "Poush", "Magh", "Falgun", "Chaitra"]), (a = `${e.day} ${r[e.month - 1]} ${e.year}`)),
                a
            );
        },
        ...
        NumberToWords: function NumberToWords(amt) {
            let FIGURE;
            let FIGLEN;
            let i;
            let WORDs = [];
            ...
            FIGLEN = FIGURE.length;
            if (FIGLEN < 12) {
                FIGURE = " ".repeat(12 - FIGLEN) + FIGURE;
            }
            if (parseInt(FIGURE.substring(0, 9)) > 1) {
                SpellNumber = "Rupees ";
            } else if (parseInt(FIGURE.substring(0, 9)) == 1) {
                SpellNumber = "Rupee ";
            }
            for (i = 1; i <= 3; i++) {
                if (parseInt(FIGURE.substring(0, 2)) < 20 && parseInt(FIGURE.substring(0, 2)) > 0) {
                    SpellNumber = SpellNumber + WORDs[parseInt(FIGURE.substring(0, 2))];
                } else if (parseInt(FIGURE.substring(0, 2)) > 19) {
                    SpellNumber = SpellNumber + tens[parseInt(FIGURE.substring(0, 1))];
                    SpellNumber = SpellNumber + WORDs[parseInt(FIGURE.substring(1, 2))];
                }
                if (i == 1 && parseInt(FIGURE.substring(0, 2)) > 0) {
                    SpellNumber = SpellNumber + " Crore ";
                } else if (i == 2 && parseInt(FIGURE.substring(0, 2)) > 0) {
                    SpellNumber = SpellNumber + " Lakh ";
                } else if (i == 3 && parseInt(FIGURE.substring(0, 2)) > 0) {
                    SpellNumber = SpellNumber + " Thousand ";
                }
                FIGURE = FIGURE.substring(2);
            }
            if (parseInt(FIGURE.substring(0, 1)) > 0) {
                SpellNumber = SpellNumber + WORDs[parseInt(FIGURE.substring(0, 1))] + " Hundred ";
            }
            FIGURE = FIGURE.substring(1);
            if (parseInt(FIGURE.substring(0, 2)) < 20 && parseInt(FIGURE.substring(0, 2)) > 0) {
                SpellNumber = SpellNumber + WORDs[parseInt(FIGURE.substring(0, 2))];
            } else if (parseInt(FIGURE.substring(0, 2)) > 19) {
                SpellNumber = SpellNumber + tens[parseInt(FIGURE.substring(0, 1))];
            ...
            FIGURE = FIGURE.substring(3);
            if (parseInt(FIGURE) > 0) {
                SpellNumber = SpellNumber + " & Paisa ";
                if (parseInt(FIGURE.substring(0, 2)) < 20 && parseInt(FIGURE.substring(0, 2)) > 0) {
                    SpellNumber = SpellNumber + WORDs[parseInt(FIGURE.substring(0, 2))];
                } else if (parseInt(FIGURE.substring(0, 2)) > 19) {
                    SpellNumber = SpellNumber + tens[parseInt(FIGURE.substring(0, 1))];
        ...
        NumberToWordsUnicode: function (e, t) {
            ...
            if (!(e.length > 13)) {
                ...
                return (
                    (h = (h = h.toString()).substring(0, h.length - 11)) > 0 && (r += n[h] + " खरब"),
                    f > 0 && (r += " " + n[f] + " अरब"),
                    m > 0 && (r += " " + n[m] + " करोड"),
                    c > 0 && (r += " " + n[c] + " लाख"),
                    s > 0 && (r += " " + n[s] + " हजार"),
...
!(function () {
    ...
    function u(t) {
        ...
        if (e) o();
            ...
            var c = null;
            null == s ? ((s = NepaliFunctions.GetCurrentBsDate()), (c = "")) : (c = NepaliFunctions.ConvertDateFormat(s, "YYYY-MM-DD")),
                d(s.year, s.month, c),
                (function (e) {
                    var t = (function (e) {
                        if ("body" != m().container) {
    ...
    function d(e, t, n, r) {
        ...
        var T = !0;
        o.disableBefore && NepaliFunctions.CompareBsDates(o.disableBefore, { year: M, month: B, day: NepaliFunctions.GetDaysInBsMonth(M, B) }) && (T = !1);
                    ...
                    for (; B < Y;) {
                        if (
                            ((M = B) % 7 == 0 && (S = document.createElement("TR")),
                                (T = M - A + 1),
                                (F = e.toString() + "-" + NepaliFunctions.Get2DigitNo(t) + "-" + NepaliFunctions.Get2DigitNo(T)),
                                (C = ""),
                                (C = e === a && t === i && T === o ? "ndp-selected" : e === f && t === h && T === p ? "ndp-current" : "ndp-date"),
                            ...
                            if (
                                ((I = document.createElement("TD")).setAttribute("class", C),
                                    (u.disableAfter && NepaliFunctions.CompareBsDates(NepaliFunctions.ConvertToDateObject(F, "YYYY-MM-DD"), u.disableAfter)) ||
                                    (u.disableBefore && NepaliFunctions.CompareBsDates(u.disableBefore, NepaliFunctions.ConvertToDateObject(F, "YYYY-MM-DD"))))
                            )
                                (x = document.createElement("A")).setAttribute("class", "ndp-disabled"),
                                ...
                                (x = document.createElement("A")).setAttribute("href", "javascript:void(0)"),
                                    x.setAttribute("title", F),
                                    ...
                                    u.isDiv && u.isDiv
                                        ...
                                        x.addEventListener("click", function () {
                                            ...
                                            u.onDateClick({ bs: NepaliFunctions.ConvertDateFormat(t, "YYYY-MM-DD"), ad: NepaliFunctions.ConvertDateFormat(NepaliFunctions.BS2AD(t), u.dateFormat), object: t });
                                        })
                                        : x.addEventListener("click", function () {
                                            l(this);
                                        }),
    ...
    function l(e) {
        ...
        if (!n.isDiv) {
            ...
            n.ndpEnglishInput && (document.getElementById(n.ndpEnglishInput).value = NepaliFunctions.ConvertDateFormat(NepaliFunctions.BS2AD(a), n.dateFormat)),
                (document.getElementById(r).value = n.unicodeDate ? NepaliFunctions.ConvertToUnicode(t) : t),
                n.onChange && n.onChange({ bs: t, ad: NepaliFunctions.ConvertDateFormat(NepaliFunctions.BS2AD(a), n.dateFormat), object: a }),
                o();
        }
    }
    function s(e, t, n, r) {
    ...
    function m(e) {
        ...
        if ((e || (e = r), e)) {
            ...
            Number.isInteger(d) && d >= 0 && (o = NepaliFunctions.BsAddDays(NepaliFunctions.GetCurrentBsDate(), -1 * d)),
                Number.isInteger(l) && l >= 0 && (u = NepaliFunctions.BsAddDays(NepaliFunctions.GetCurrentBsDate(), l)),
                a &&
                (t = {
    ...
    function p(e) {
        var t = "english" == e.language,
            ...
            r = "";
        e.isDiv ? ((r = "-" + e.id), n.setAttribute("class", "ndp-nepali-box ndp-corner-all")) : (n.setAttribute("id", "ndp-nepali-box"), n.setAttribute("class", "ndp-corner-all")),
        ...
        d.setAttribute("class", "ndp-days"),
            (t ? NepaliFunctions.GetAdDaysShort() : NepaliFunctions.GetBsDaysUnicodeShort()).forEach(function (e) {
    ...
    (Object.prototype.nepaliDatePicker = function (l) {
        var s = this;
        if ("remove" != l) {
            if (((l = void 0 === l ? {} : l), s.length && s.length > 0)) for (y = 0; y < s.length; y++) g(s[y], l);
            else g(s, l);
        ...
        function g(e, t) {
            ...
            if (
                ...
                if (t.disableBefore || t.disableAfter) {
                    var M = null;
                    t.disableAfter && ((M = NepaliFunctions.ConvertToDateObject(t.disableAfter, t.dateFormat || "YYYY-MM-DD")), NepaliFunctions.CompareBsDates(M, v) || ((g = M.year), (A = M.month)));
                }
                d(g, A, "", t.id);
            }
        }
